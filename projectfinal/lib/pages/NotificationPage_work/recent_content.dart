          ...
          itemBuilder: (context, orgIndex) {
            ...
            return StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  ...
                  .snapshots(),
              builder:
                  (context, AsyncSnapshot<QuerySnapshot> annoncesSnapshot) {
                if (annoncesSnapshot.connectionState ==
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    final annonceData =
                        annoncesDocs[index].data() as Map<String, dynamic>;
                    final category =
                        annonceData['category'] ?? 'Category not available';
                    final annonceTitle =
                        annonceData['annonceTitle'] ?? 'Title not available';
                    final description = annonceData['description'] ??
                        'Description not available';
                    final quantityNeeded = annonceData['quantityNeeded'] ??
                        'Quantity needed not available';
                    final quantityDonated = annonceData['quantityDonated'] ??
                        'Quantity donated not available';
                    final endDate =
                        annonceData['endDate'] ?? 'End date not available';
